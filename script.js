...
(function(){
  ...
  const CONTEXTS = {
    ...
    scarcity: {
      ...
      lead: 'Осталось 8 из 10 мест. Зафиксируем −50% на паушальный (до конца года) и первоочерёдность выбора города.'
    },
    togo: {
      title: 'Формат TO-GO',
      lead: 'Компактная точка от 2,5 млн ₽. Со скидкой до конца года — паушальный 250 000 ₽.'
    },
    cafe: {
      title: 'Формат КОФЕЙНЯ',
      lead: 'Основной формат от 5 млн ₽. Со скидкой до конца года — паушальный 400 000 ₽.'
    },
    bistro: {
      title: 'Формат БИСТРО',
      lead: 'Флагманский формат от 12 млн ₽. Со скидкой до конца года — паушальный 600 000 ₽.'
    }
  };
